...
с круткой 50 кр/м (норма прочности: не менее 260 сН/текс, CV не более 9% — выше 9% партия бракуется,
...
Если в фактах есть «диагнозы_машин» — используй их для адресных рекомендаций:
«обслуживание» = низкая прочность и высокий CV одновременно (машина запущена комплексно);
«техсостояние» = устойчиво низкая прочность (износ узлов формования);
«кручение/намотка» = только высокий CV (натяжение, бегунок, веретено);
«деградация» = показатели в норме, но устойчивый тренд вниз — ранний сигнал.
