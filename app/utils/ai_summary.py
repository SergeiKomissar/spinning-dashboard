...
Напиши краткую технологическую сводку на русском языке (150–250 слов) в Markdown:
...
- Пиши по-деловому, без воды. Номера машин — «ПМ 23», аппаратов — «ВТВ №18»."""
    ...
    resp = requests.post(
        ...
        json={
            ...
            "messages": [
                ...
                {"role": "user", "content": f"Факты диагностики:\n```json\n{facts_text}\n```"},
            ],
        },
        timeout=90,
    )
